    ...
    const helpEmbed = new EmbedBuilder()
      ...
      .setDescription(
        [
          ...
          '',
          '📝 **Botón "Letra":**',
          '- Si hay una canción sonando (detectada por Jockie Music), el panel mostrará el botón "Letra".',
          '- Al pulsar el botón, el bot buscará la letra de la canción y la publicará en el canal.',
          '- Si la canción tiene varios artistas, el bot intentará buscar la letra con cada uno y también con todos los artistas juntos.',
          '- Puedes cerrar todos los mensajes de la letra usando el botón "Cerrar" en el primer mensaje de la letra.',
          '',
